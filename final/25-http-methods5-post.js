...
// go to methods-public and then javascript.html which is the same app but in js-in browser on navbar we have "regular" and "javascript"
//you can choose js here
//in javascript.html file unlike the index.html file, we don't have action or method in form but we have the name attribute
//in js file we use axios instead of fetch which is easier but it needs installation
...
//I have the input value and pass it as a name property
...
app.post('/api/people',(req,res)=>{
    ...
    // res.status(201).send('Success')    //if we are doing post request and we are successful we use 201--in js tab on browser if we add name in input, on inspect>>network tab we receive people and 201
