...
const people = require('./routes/people')   //same as people.js
...
//Note:because here we have the path: '/api/people' here we should delete this path in the methods in people.js and add '/' instead
app.use('/api/people', people)   //main path for/api/people

//New: move the post method with '/login' to the auth.js file under the routes folder
